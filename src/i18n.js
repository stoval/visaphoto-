...
const I18N = {
  zh: {
    ...
    selectedFormatLabel: '当前规格',
    selectedFormatAction: '更改规格',
  ...
  en: {
    ...
    heroFormatsCta: 'Review selected format',
    ...
    selectedFormatAction: 'Change format',
  ...
  'zh-TW': {
    ...
    metaTitle: 'VisaPics | 在瀏覽器中私密製作護照與簽證照片',
    metaDescription: '直接在瀏覽器中製作護照、簽證與證件照。可去除背景、選擇標準尺寸，並快速匯出可用圖片，全程更私密。',
    heroEyebrow: '瀏覽器內私密證件照工具',
    heroTitle: '在瀏覽器中私密製作護照與簽證照片',
    heroSubtitle: '先選擇證件類型，上傳人像照片、去除背景，並在幾分鐘內匯出可直接使用的照片，無需將圖片傳送到遠端伺服器。',
    heroUploadCta: '上傳照片',
    heroFormatsCta: '查看目前規格',
    heroTrustLine: '本機執行 · 照片保留在你的裝置上',
    feature1Title: '本機處理',
    feature1Body: '編輯過程在瀏覽器內完成，照片在處理期間保留在你的裝置上。',
    feature2Title: '自動去除背景',
    feature2Body: '快速去除背景，並在匯出前微調結果。',
    feature3Title: '內建常用規格',
    feature3Body: '可選擇多國常見的護照、簽證和證件照尺寸。',
    feature4Title: '靈活匯出',
    feature4Body: '可下載單張照片或可列印的排版圖，支援 JPG 和 PNG。',
    startHereLabel: '開始使用',
    startHereTitle: '先選擇規格，再上傳照片',
    startHereBody: '先為你的證件選擇預設規格；如有需要，也可以使用自訂尺寸。然後上傳一張清晰的人像照片開始製作。',
    selectedFormatLabel: '目前規格',
    selectedFormatAction: '更改規格',
    documentTypeLabel: '證件類型',
    documentTypeHint: '先選擇護照、簽證或證件照規格，再開始上傳。',
    advancedOptionsLabel: '進階選項',
    advancedOptionsHint: '參考線、自訂尺寸、背景色與影像調整',
    dropSubTitle: '拖放照片到這裡，或點擊選擇檔案',
    howItWorksLabel: '使用流程',
    howItWorksTitle: '4 步生成合規照片',
    flow1Title: '上傳照片',
    flow1Body: '從手機或電腦中選擇一張清晰的人像照。',
    flow2Title: '去除背景',
    flow2Body: '自動去除背景，並依需要微調構圖。',
    flow3Title: '選擇尺寸和背景',
    flow3Body: '為你的證件選擇所需規格與背景顏色。',
    flow4Title: '下載最終照片',
    flow4Body: '匯出數位照片或可列印的排版圖。',
    bestResultsLabel: '更佳效果',
    bestResultsTitle: '讓結果更乾淨的小提示',
    tip1: '使用正面人像照',
    tip2: '讓臉部光線盡量均勻',
    tip3: '避免強烈逆光',
    tip4: '盡量使用純色背景',
    ...
    confirmSaveChinaCutout: '已替換為白底背景。建議先保存這張白底圖，方便後續網上申請護照/簽證時上傳或備用。',
  ...
  ja: {
    ...
    metaTitle: 'VisaPics | ブラウザ内でパスポート・ビザ写真をプライベート作成',
    metaDescription: 'パスポート、ビザ、各種証明写真をブラウザで直接作成。背景除去、標準サイズ選択、画像書き出しまでをすばやく、よりプライベートに行えます。',
    heroEyebrow: 'ブラウザ内で使えるプライベート証明写真ツール',
    heroTitle: 'ブラウザ内でパスポート・ビザ写真をプライベート作成',
    heroSubtitle: '書類の種類を選び、顔写真をアップロードし、背景を除去して、数分でそのまま使える証明写真を書き出せます。写真をリモートサーバーへ送信する必要はありません。',
    heroUploadCta: '写真をアップロード',
    heroFormatsCta: '規格を選ぶ',
    heroTrustLine: 'ローカル処理 · 写真は端末内に保持されます',
    feature1Title: 'ローカル処理',
    feature1Body: '編集はブラウザ内で完結し、処理中も写真は端末内に保持されます。',
    feature2Title: '自動背景除去',
    feature2Body: '背景をすばやく削除し、書き出し前に結果を微調整できます。',
    feature3Title: 'よく使う規格を内蔵',
    feature3Body: '複数の国で使われる一般的なパスポート、ビザ、証明写真サイズを選べます。',
    feature4Title: '柔軟な書き出し',
    feature4Body: '単写真または印刷用シートを JPG / PNG でダウンロードできます。',
    startHereLabel: 'ここから開始',
    startHereTitle: '規格を選んで写真をアップロード',
    startHereBody: 'まず書類に合ったプリセット規格を選択します。必要に応じてカスタムサイズも使用できます。その後、鮮明な顔写真をアップロードして作成を始めてください。',
    selectedFormatLabel: '選択中の規格',
    selectedFormatAction: '規格を変更',
    documentTypeLabel: '書類タイプ',
    documentTypeHint: 'アップロード前に、パスポート、ビザ、または証明写真の規格を選択してください。',
    advancedOptionsLabel: '詳細オプション',
    advancedOptionsHint: 'ガイド、カスタムサイズ、背景色、画像調整',
    dropSubTitle: 'ここに写真をドラッグ＆ドロップ、またはクリックしてファイルを選択',
    howItWorksLabel: '使い方',
    howItWorksTitle: '4 ステップで適合写真を作成',
    flow1Title: '写真をアップロード',
    flow1Body: 'スマートフォンまたはパソコンから鮮明な顔写真を選びます。',
    flow2Title: '背景を除去',
    flow2Body: '背景を自動で除去し、必要に応じて構図を微調整します。',
    flow3Title: 'サイズと背景を選択',
    flow3Body: '書類に必要な規格と背景色を選択します。',
    flow4Title: '最終写真をダウンロード',
    flow4Body: 'デジタル写真または印刷用シートを書き出します。',
    bestResultsLabel: 'より良い仕上がり',
    bestResultsTitle: 'きれいに仕上げるためのヒント',
    tip1: '正面向きの顔写真を使う',
    tip2: '顔に均一な光を当てる',
    tip3: '強い逆光を避ける',
    tip4: 'できるだけ無地の背景を使う',
    tip5: '頭部と肩の周囲に十分な余白を残す',
    ...
    confirmSaveChinaCutout: '背景を白に変更しました。あとでオンラインでパスポート/ビザを申請する際のアップロード用や予備として、この白背景画像を先に保存しておくことをおすすめします。',
  ...
  ko: {
    ...
    metaTitle: 'VisaPics | 브라우저에서 여권·비자 사진을 비공개로 제작',
    metaDescription: '여권, 비자, 각종 증명사진을 브라우저에서 바로 제작하세요. 배경 제거, 표준 규격 선택, 이미지 내보내기까지 빠르고 더 안전하게 처리할 수 있습니다.',
    heroEyebrow: '브라우저에서 사용하는 비공개 증명사진 도구',
    heroTitle: '브라우저에서 여권·비자 사진을 비공개로 제작',
    heroSubtitle: '문서 종류를 선택하고, 인물 사진을 업로드한 뒤, 배경을 제거하여 몇 분 안에 바로 사용할 수 있는 증명사진으로 내보낼 수 있습니다. 사진을 원격 서버로 보낼 필요가 없습니다.',
    heroUploadCta: '사진 업로드',
    heroFormatsCta: '규격 선택',
    heroTrustLine: '로컬 처리 · 사진은 내 기기에만 저장됩니다',
    feature1Title: '로컬 처리',
    feature1Body: '편집은 브라우저 안에서 끝나며, 처리 중에도 사진은 내 기기에만 남아 있습니다.',
    feature2Title: '자동 배경 제거',
    feature2Body: '배경을 빠르게 제거하고, 내보내기 전에 결과를 미세 조정할 수 있습니다.',
    feature3Title: '자주 쓰는 규격 내장',
    feature3Body: '여러 나라에서 쓰이는 일반적인 여권, 비자, 증명사진 규격을 선택할 수 있습니다.',
    feature4Title: '유연한 내보내기',
    feature4Body: '단일 사진 또는 인쇄용 시트를 JPG / PNG 형식으로 다운로드할 수 있습니다.',
    startHereLabel: '여기서 시작',
    startHereTitle: '규격을 선택하고 사진을 업로드하세요',
    startHereBody: '먼저 문서에 맞는 사전 설정 규격을 선택하세요. 필요하면 사용자 지정 크기도 사용할 수 있습니다. 그런 다음 선명한 인물 사진을 업로드해 제작을 시작하세요.',
    selectedFormatLabel: '선택된 규격',
    selectedFormatAction: '규격 변경',
    documentTypeLabel: '문서 종류',
    documentTypeHint: '업로드 전에 여권, 비자 또는 증명사진 규격을 먼저 선택하세요.',
    advancedOptionsLabel: '고급 옵션',
    advancedOptionsHint: '가이드, 사용자 크기, 배경색, 이미지 조정',
    dropSubTitle: '여기로 사진을 드래그 앤 드롭하거나 클릭해서 파일을 선택하세요',
    howItWorksLabel: '사용 방법',
    howItWorksTitle: '4단계로 규격에 맞는 사진 만들기',
    flow1Title: '사진 업로드',
    flow1Body: '휴대폰이나 컴퓨터에서 선명한 인물 사진을 선택하세요.',
    flow2Title: '배경 제거',
    flow2Body: '배경을 자동으로 제거하고 필요에 따라 구도를 미세 조정합니다.',
    flow3Title: '크기와 배경 선택',
    flow3Body: '문서에 필요한 규격과 배경색을 선택하세요.',
    flow4Title: '최종 사진 다운로드',
    flow4Body: '디지털 사진 또는 인쇄용 시트를 내보냅니다.',
    bestResultsLabel: '더 좋은 결과',
    bestResultsTitle: '더 깔끔한 결과를 위한 팁',
    tip1: '정면 인물 사진을 사용하세요',
    tip2: '얼굴에 빛이 고르게 비치도록 하세요',
    tip3: '강한 역광을 피하세요',
    tip4: '가능하면 단색 배경을 사용하세요',
    tip5: '머리와 어깨 주변에 충분한 여백을 남기세요',
    ...
    confirmSaveChinaCutout: '배경이 흰색으로 변경되었습니다. 이후 온라인으로 여권/비자를 신청할 때 업로드하거나 예비용으로 쓸 수 있도록, 이 흰 배경 사진을 먼저 저장해 두는 것을 권장합니다.',
...
function applyI18n() {
  ...
  const textMap = {
    ...
    selectedFormatAction: 'selectedFormatAction',
